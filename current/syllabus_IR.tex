...
\paragraph{Participation (20\%):} Students are expected to participation in all seminar discussions. In addition, they have to choose three sessions and prepare a brief memo (around 2 pages) for each of them, summarizing and connecting readings. Submission before class starts.
