...
Master in Social Sciences\\UC3M / Juan Linz Institute\\
...
\section*{Key dates 2026}

\begin{center}
\begin{tabular}{|l|l|}
\hline
Proposal presentations      & April 16 \textbf{(*)} \\
\hline
In-class exam               & April 30 \textbf{(**)} \\
\hline
Final essay submission      & May 20 \\
Final essay (extraordinary) & June 12 \\
\hline
\multicolumn{2}{l}{\footnotesize \textbf{(*)} A second date may be added}\\
\multicolumn{2}{l}{\footnotesize \textbf{(**)} Short exam, only first half of class}
...
I will provide a more specific list of readings and textbooks, but we will rely on several textbooks and materials. I detail below which chapters correspond to each session. Some of these are freely available online and many provide code and data resources. In addition, I list below other books that either focus more on the use of R or on causal inference.

\begin{itemize}
\setlength\itemsep{-5pt}
  \item Urdinez and Cruz, \href{https://www.routledge.com/R-for-Political-Data-Science-A-Practical-Guide/Urdinez-Cruz/p/book/9780367818838}{\textit{R for Political Data Science: A Practical Guide}} (CRC, 2020).
  \item Imai, \href{https://press.princeton.edu/books/hardcover/9780691167039/quantitative-social-science}{\textit{Quantitative Social Science: An Introduction}} (Princeton UP, 2017).
  \item Gelman, Hill, and Vehtari, \href{https://avehtari.github.io/ROS-Examples/}{\textit{Regression and Other Stories}} (Cambridge UP, 2021).
  \item Bueno de Mesquina and Fowler, \href{https://press.princeton.edu/books/hardcover/9780691214368/thinking-clearly-with-data}{\textit{Thinking Clearly with Data: A Guide to Quantitative Reasoning and Analysis}} (Princeton UP, 2021).
...
This schedule is subject to changes depending on our progress during the semester.
A detailed outline for each session can be found in the course website\\(\href{https://franvillamil.github.io/AQM2/}{franvillamil.github.io/AQM2/}).
...
\begin{table*}[!ht]
  ...
  \begin{tabular}{lll}
    ...
    \textbf{Session 5} & March 5 & Panel data (I) \\
    \textbf{Session 6} & March 12 & Panel data (II) \\
    \textbf{Session 7} & March 19 & Spatial data (I) \\
    \textbf{Session 8} & March 26 & Spatial data (II) \\
    \textbf{Session 9} &  April 9 & Other outcomes (nominal, ordinal, count, duration) \\
    \textbf{Session 10} & April 16 & Project presentations \\
    \textbf{Session 11} & April 23 & Best practices in computing \\
    \textbf{Session 12} & April 30 & Exam + Review/Advanced topics \\
  \end{tabular}
\end{table*}
